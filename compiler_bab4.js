...
async function executeCode() {
    ...
    terminalOutput.innerText = "Mengevaluasi cabang logika...";
    ...
    try {
        ...
        // ==========================================
        // 3. LOGIKA SMART AUTO-GRADER BAB 4
        // ==========================================
        const cleanOutput = programOutput.replace(/\r\n/g, '\n');

        // Kunci Jawaban Bab 4
        const targetLatihan1 = "Akses Diberikan";
        const targetLatihan2 = "1";
        const targetLatihan3 = "Akses Ditolak";
        const targetLatihan4 = "Silver";
        const targetLatihan5 = "Blokir";
        
        // Kunci Jawaban Ujian Akhir (Algoritma Maks & Min)
        // A = 28756, B = 24057, C = 29295. Terbesar C, Terkecil B.
        const targetUjianAkhir = "Terbesar: Node C\nTerkecil: Node B";

        if (cleanOutput === targetUjianAkhir) {
            missionStatus.innerText = "STATUS: LULUS UJIAN BAB 4!";
